...
def classification():
    ...
    ai2d_builder = ai2d.build(
        [1, 3, OUT_RGB888P_HEIGH, OUT_RGB888P_WIDTH], [1, 3, model_input_size[1], model_input_size[0]]
    )
            ...
            if rgb888p_img.format() == image.RGBP888:
                ...
                if num_classes > 2:
                    ...
                    if sigmoid_res > confidence_threshold:
                        ...
                        print("score", score)
            osd_img.clear()
            if cls_idx >= 0 and score >= 0.7:
                osd_img.draw_string_advanced(
                    5, 5, 32, "result:" + labels[cls_idx] + " score:" + str(round(score, 3)), color=(0, 255, 0)
                )
                uart2.write('!' + str(labels[cls_idx]) + '@')
